...
def options_widget(frame, 
    ...
    This function creates an options widget within a speficied frame.
    ...
    options_var.set(options[default_idx])
    
    # create widget for user feedback
    options_wid = tk.OptionMenu(frame, options_var, *options)
    options_wid.grid(row = row, column = column, padx = padx, pady = pady, sticky = sticky)
